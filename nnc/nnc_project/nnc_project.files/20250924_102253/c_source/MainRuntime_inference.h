...
/// Input buffer sizes.
#define NNABLART_MAINRUNTIME_INPUT0_SIZE (3)
/// Pointer of allocated buffer.
float* nnablart_mainruntime_input_buffer(void* context, int index);

/// Number of output buffers.
#define NNABLART_MAINRUNTIME_NUM_OF_OUTPUT_BUFFERS (2)
/// Output buffer sizes.
#define NNABLART_MAINRUNTIME_OUTPUT0_SIZE (5)
#define NNABLART_MAINRUNTIME_OUTPUT1_SIZE (5)
/// Pointer of allocated buffer.
...
#define NNABLART_MAINRUNTIME_PARAM0_SIZE (48)
#define NNABLART_MAINRUNTIME_PARAM1_SIZE (16)
#define NNABLART_MAINRUNTIME_PARAM2_SIZE (80)
#define NNABLART_MAINRUNTIME_PARAM3_SIZE (5)
/// Pointer of allocated buffer.
