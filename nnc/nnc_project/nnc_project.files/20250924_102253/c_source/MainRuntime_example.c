...
int main(int argc, char* argv[])
{
    ...
    assert(output1);
    int output_write_size1 = fwrite(nnablart_mainruntime_output_buffer(context, 1), sizeof(float), NNABLART_MAINRUNTIME_OUTPUT1_SIZE, output1);
    assert(output_write_size1 == NNABLART_MAINRUNTIME_OUTPUT1_SIZE);
    fclose(output1);
